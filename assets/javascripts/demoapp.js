...
//tabs
    $win.load(function() {
      aboutpage("search.cfm");
});
        
        
    $( ".list-links li:nth-child(1)" ).click(function() {
        aboutpage("partial-home-section.html");
    }); 
        
    $( ".list-links li:nth-child(2)" ).click(function() {
        aboutpage("partial-about.html");
    });     
        
     $( ".list-links li:nth-child(3)" ).click(function() {
        aboutpage("schedule-a-workshop.html");
    });     
        
         $( ".list-links li:nth-child(4)" ).click(function() {
        aboutpage("search.cfm");
    }); 
        
    function aboutpage(myurl){
        $( "#success" ).load( myurl, function( response, status, xhr ) {
        if ( status == "error" ) {
