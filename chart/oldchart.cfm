...
<head>
  <script type="text/javascript" src="https://www.google.com/jsapi"></script>
        ...
        <cfoutput>colors: [#pieColors#]</cfoutput>    
            ...
            <cfoutput>
                <cfloop index="i" from="1" to="#qrySchools.recordcount#">
                    ...
                    pie_div#i#.innerHTML = '<img src="' + chart#i#.getImageURI() + '">';        
                    });
    ...
    <body>
        <cfoutput>
            <cfloop index="i" from="1" to="#qrySchools.recordcount#">
                <div id="piechart#i#" style="width: 50px; height: 50px;"></div> #qrySchools.campus[i]# <br /> School ID Number = #qrySchools.id_number[i]#
            </cfloop>
        </cfoutput>    
    </body>
</html>    