...
<cfif qrySchools.recordcount GT 0>
    <cfset schoolbg = "assets/images/profile" & "#qrySchools.school_level[1]#" & ".jpg">
    <cfset reportcardbg = "assets/images/reportCard" & "#qrySchools.school_level[1]#" & ".jpg">
</cfif>
...
<head>
    ...
    <style>
        ...
        #schools, #rank{
         ...
         #ReportCard {
            <cfoutput>
                    background-image: url('#reportcardbg#');
                </cfoutput>    
            height: 1200px;
            width: 1000px;
            padding: 0px;
...
<section>
    ...
    <table>
        ...
        <tr>
            <td><a href="##" data-toggle="tooltip" title="Hooray!">#displayLang("Special Education","#lang#")#</a></td>
    ...
    <section>
                <div class="nav">
                    <table class="navTable">
                        <tr>
                            <td>
                                <a href="##schools"><img src="assets/images/campus_profile_icon.png">
                                </a>
                            </td>
                            <td>
                                <a href="##ReportCard"><img src="assets/images/report_card.png">
                                </a>
                            </td>
                            <td>
                                <a href="##Rank"><img src="assets/images/state_rank.png">
                                </a>
                            </td>
                        </tr>
                        <tr>
        ...
        <section class="myReportCard">
            <div>
                     <table style="width:400px">
                         ...
                         <tr>
                            <td colspan="2">
                             <h1>2015 Report Card </h1><span id="grade" style="position:relative;top:-25px;left:150px"><p style="color:#gradeColor(letter_grade)#">#GRADE_2014#</p>
                             </td>
                         </tr>
                        ...
                        <tr>
                            <td nowrap><a href="##" data-toggle="tooltip" title="STAAR is the State of Texas Assessments of Academic Readiness that measures student’s performance">#displayLang("STAAR Math - Adv","#lang#")#*</a></td>
                        ...
                        <tr>
                            <td nowrap><a href="##" data-toggle="tooltip" title="STAAR is the State of Texas Assessments of Academic Readiness that measures student’s performance">#displayLang("STAAR Reading - Adv","#lang#")#</a></td>
                        ...
                        <tr>
                            <td><a href="##" data-toggle="tooltip" title="A measure of student-level performance relative to a student’s test-score peers.">#displayLang("Reading Gain Score","#lang#")#*</a></td>
                            <td>
