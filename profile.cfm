...
FROM schools
    ...
    <cfif isdefined("url.ID_NUMBER") AND url.ID_NUMBER NEQ "">
    	AND ID_NUMBER = <cfqueryparam value = "#url.ID_NUMBER#" cfsqltype = "cf_sql_char" maxLength = "14">
    </cfif>
</cfquery>
              ...
              <div class="row">
                    <div class="col-xs-9">
                        <table style="width:950">
                            <tr>
                                <td style="width:750"><div class="schoolName">#campus#</div></td>
                                <td>
...
data: {
	...
	columns: [
         ...
         <cfif qrySchools.white neq 'N/A'>
         ['White', <cfoutput>#white#</cfoutput>],
        </cfif>
        <cfif qrySchools.black neq 'N/A'>
         ['Black', <cfoutput>#black#</cfoutput>],
        </cfif>
         <cfif qrySchools.hispanic neq 'N/A'>
         ['Hispanic', <cfoutput>#hispanic#</cfoutput>],
        </cfif>
         <cfif qrySchools.others neq 'N/A'>
         ['Other', <cfoutput>#others#</cfoutput>]
        </cfif>
         ],
	type : 'pie'
},
color: {
  pattern: ['#1f77b4', 'orange', 'green','red']
},  
legend: {
show: false
},
